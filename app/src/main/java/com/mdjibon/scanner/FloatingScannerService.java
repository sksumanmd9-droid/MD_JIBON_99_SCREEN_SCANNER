...
public class FloatingScannerService extends Service {
    ...
    public int onStartCommand(
        ...
        /*
         * Service নিজে থেকে বন্ধ হবে না।
         * শুধুমাত্র MainActivity থেকে stopService()
         * করা হলে বন্ধ হবে।
         */

        if (intent != null &&
                ScreenCaptureService.ACTION_STOP.equals(
                        intent.getAction()
                )) {
