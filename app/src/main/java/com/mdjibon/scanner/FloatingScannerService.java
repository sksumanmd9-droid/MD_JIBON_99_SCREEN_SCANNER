...
public class FloatingScannerService extends Service {
    ...
    public int onStartCommand(Intent i, int f, int id) {
        ...
        if (receiver == null) {
            receiver = new BroadcastReceiver() {
                public void onReceive(Context c, Intent x) {
                    String sig = x.getStringExtra("signal");
                    int conf = x.getIntExtra("confidence", 0);
            ...
            if (Build.VERSION.SDK_INT >= 33)
                registerReceiver(receiver,
                        new IntentFilter("MDJIBON_SCAN_RESULT"),
    ...
    void show() {
        ...
        b.setBackgroundColor(Color.rgb(0, 180, 90));
        ...
        b.setOnClickListener(v -> {
            ...
            s.setAction("SCAN_NOW");
            startService(s);

            Toast.makeText(
                    this,
                    "স্ক্রিন স্ক্যান হচ্ছে…",
                    Toast.LENGTH_SHORT
            ).show();
        });
